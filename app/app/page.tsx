...
export default function Tracker() {
  ...
  const refMax = selectedMarker?.refWindowMax
    ...
    <>
      ...
      <Section>
        <GlassCard>
          ...
          <ChartBBT days={entries} markers={out.markers} />
          <div className="text-xs text-slate-500 mt-3">Mucus lane shows intensity (higher = more fertile characteristics). Vertical markers: Peak (..), P+3 (.- -), Temp Shift (- -).</div>
        </GlassCard>
      </Section>
