        ...
        return (
          ...
          >
            ...
            <div className="cal-icons">
              {bleeding && <IconDroplet aria-label="bleeding" size={16} />}
              {mucus && <IconSparkle aria-label="fertile mucus" size={16} />}
              {coitus && <IconHeart aria-label="intercourse" size={16} />}
              {filled && !bleeding && !mucus && !coitus && <IconDot aria-label="logged" size={8} />}
            </div>
          </button>
        )
      })}
