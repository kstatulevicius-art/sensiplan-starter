...
export function FertileTiny(){ return <span aria-label="fertile" title="Fertile">💧</span> } // using droplet for fertile mucus
...
export function LifestyleTiny(){ return <span aria-label="lifestyle" title="Lifestyle">⚑</span> }
